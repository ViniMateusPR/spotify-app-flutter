...
import 'package:spotifyapp/presentation/splash/home/bloc/news_songs_cubit.dart';
    ...
    return ListView.separated(
        ...
        itemBuilder: (context,index) {
          return GestureDetector(
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => SongPlayerPage(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                              fit: BoxFit.cover,
                              image: NetworkImage(
                                  '${AppUrls.coverfirestorage}${songs[index].artist}.jpeg?${AppUrls.mediaAlt}'
                              )
                          )
                      ),
                      child: Align(
                        ...
                        child: Container(
                          ...
                          child: Icon(
                            ...
                            color: context.isDarkMode ? const Color(0xFF959595) : const Color(0xff55555),
                          ),
                        ),
                      ),
                    ),
